...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kesavaram — Authentic Siddha Wellness & Massage" },
      ...
      { property: "og:title", content: "Kesavaram — Authentic Siddha Wellness & Massage" },
      ...
      { name: "twitter:title", content: "Kesavaram — Authentic Siddha Wellness & Massage" },
