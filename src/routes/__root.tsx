...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kesavaram.co — Authentic Siddha Wellness & Massage" },
      { name: "description", content: "Healing. Naturally. Delivered to You. Order authentic Siddha products and book expert massage services in Dindigul via WhatsApp." },
      { property: "og:site_name", content: "Kesavaram.co" },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "Kesavaram.co — Authentic Siddha Wellness & Massage" },
      { property: "og:description", content: "Healing. Naturally. Delivered to You. Order authentic Siddha products and book expert massage services in Dindigul via WhatsApp." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Kesavaram.co — Authentic Siddha Wellness & Massage" },
      { name: "twitter:description", content: "Healing. Naturally. Delivered to You. Order authentic Siddha products and book expert massage services in Dindigul via WhatsApp." },
